...
class DMOSkillsConfig {
    ...
    @SerializedName("discovery") var discovery = Discovery()
    @SerializedName("experience") var exp = Experience()

    class Experience {
        @SerializedName("lumbering") var lumbering = DMOConfigGeneric()
        @SerializedName("mining") var mining = DMOConfigGeneric()
        @SerializedName("foraging") var foraging = DMOConfigGeneric()
        @SerializedName("fishing") var fishing = DMOConfigGeneric()
        @SerializedName("cultivation") var cultivation = DMOConfigGeneric()
        @SerializedName("animal_care") var animalCare = DMOConfigGeneric()
        @SerializedName("trading") var trading = DMOConfigGeneric()
        @SerializedName("cartography") var cartography = DMOConfigGeneric()
        @SerializedName("dungeoneer") var dungeoneer = DMOConfigDungeoneer()
        @SerializedName("melee") var melee = DMOConfigGeneric()
        @SerializedName("archery") var archery = DMOConfigGeneric()
        @SerializedName("hunter") var hunter = DMOConfigGeneric()
        @SerializedName("alchemy") var alchemy = DMOConfigGeneric()
        @SerializedName("enchanting") var enchanting = DMOConfigGeneric()
        @SerializedName("metalwork") var metalwork = DMOConfigGeneric()
        @SerializedName("cooking") var cooking = DMOConfigGeneric()
    }

    class Discovery {
        @SerializedName("toasts_enabled") var toastsEnabled: Boolean = false
        @SerializedName("toast_duration_seconds") var toastDurationSeconds: Int = 5
    ...
    fun isDiscoveredByDefault(skill: Skill) = !when(skill) {
        ...
        ARCHERY -> exp.archery.defaultHidden
